  ...
  // Run
{
  ...
  out.print("filter scan resultSize: {}, isRange :{}\n", resultSize, isRange);
  ...
  // Run
{
  ...
  out.print("self join resultSize: {}\n", resultSize);
}
//---------------------------------------------------------------------------
void Checksum::run()
  // Run
{
  ...
  out.print("is range: {}, result size {}\n", input->isRangeResult(), resultSize);
  if (resultSize == 0) {
